...
import { Box, Typography, Toolbar, CssBaseline, TextField, Button, Select, MenuItem, InputLabel, FormControl, Checkbox, FormControlLabel, Link, RadioGroup, Radio } from '@mui/material';
...
function AddPrty() {
	...
	const [partyOrDeveloper, setPartyOrDeveloper] = useState<string>('');

	const handleRadioChange = (event: React.ChangeEvent<HTMLInputElement>) => {
		setPartyOrDeveloper(event.target.value);
	};
	...
	const partySubmit = async (event: React.FormEvent) => {
		...
		formData.append("partyOrDeveloper", partyOrDeveloper);
	...
	return (
		<Box sx={{ display: 'flex', flexGrow: 1, overflow: 'hidden', }}>
			...
			<Box component="main" sx={{ flexGrow: 1, p: 2, width: "800px", }}>
				...
				<Box component="section" sx={{ display: 'flex', flexDirection: 'column', mt: 2, mb: 2 }}>
				<RadioGroup
					row
					value={partyOrDeveloper}
					onChange={handleRadioChange}
					name="partyOrDeveloper"
				>
